...
import { ArrowLeft, Cpu, Loader2, RefreshCw } from "lucide-react";
...
import { GoalsSection } from "@/components/my-data/GoalsSection";
import { PreferencesSection } from "@/components/my-data/PreferencesSection";
import { GenesisSection, IdentitySection } from "@/components/my-data/GenesisAndIdentity";
import { SectionCard } from "@/components/my-data/SectionCard";
...
export default function MyDataPage() {
  ...
  async function loadAll() {
    ...
    try {
      ...
      setIdentity(id);
      setPatterns(pat);
      // Find genesis from memories list
      const gen = mems.find((m: any) => m.is_genesis) ?? null;
      setGenesis(gen);
    } catch (e: unknown) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="mx-auto flex max-w-4xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-sm">My Data</span>
            </div>
          </div>
          <Button
            variant="ghost"
      ...
      <main className="mx-auto max-w-4xl px-6 py-8 space-y-6">
        {/* Page title */}
        <div>
          <h1 className="text-2xl font-bold text-foreground">Your Chronos Data</h1>
          <p className="text-sm text-muted mt-1">
            Everything Chronos knows about {firstName}. You own this data — view, edit, and correct it any time.
          </p>
        </div>
